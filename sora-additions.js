...
(function() {
    ...
    window.addEventListener('load', async function() {
        ...
        const parallelContainer = mainPanel.querySelector('#sora-parallel-container');
        ...
        GM_addStyle(`
            ...
            #sora-settings-close-button { font-size: 28px; color: #888; cursor: pointer; line-height: 1; }
